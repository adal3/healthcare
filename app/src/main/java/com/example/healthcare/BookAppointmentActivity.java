...
public class BookAppointmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv = findViewById(R.id.textViewBMPAppTitle);
        ...
        Intent it = getIntent();
        final String title = it.getStringExtra("text1");
        final String fullname = it.getStringExtra("text2");
        final String address = it.getStringExtra("text3");
        final String contact = it.getStringExtra("text4");
        final String fees = it.getStringExtra("text5");
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (db.checkAppointmentExists(username,title+" => "+fullname,address,contact,dateButton.getText().toString(),timeButton.getText().toString())==1){
                    ...
                    Toast.makeText(getApplicationContext(),"Your Appointment is Booked", Toast.LENGTH_LONG).show();
